...
/* UserRepository.findUserByEmail('brunoariel.dev@gmail.com'). then(result =>{
    console.log(result)
    })
    UserRepository.verifyUser(1)
    */
        ...
        await sendMail(
            {
                ...
                <a
                    href='${ENVIROMENT.URL_BACKEND}/api/auth/verify-email?verification_token=${verificationToken}'
                    >
                    verificar 
                    </a>
            `
